...
export const ListRoomTenant = () => {
  ...
  console.log(properties, 'ini properties');
              ...
              {room.map((room) => (
                <>
                  ...
                  <td class="p-4 border-b border-blue-gray-50">
                    <div class="flex flex-col">
                      <p class="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                        {room.Location.province} ini provinsi
                      </p>
                      <p class="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900 opacity-70">
                        {room.Location.city} ini city
                      </p>
                    </div>
                  </td>
                  <td class="p-4 border-b border-blue-gray-50">
                    <div class="w-max">
                      <div class="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-black-500 uppercase rounded-md select-none whitespace-nowrap bg-green-500/20">
                        {room.Property_category?.Categories}
                      </div>
                    </div>
                  </td>
                  <td class="p-4 border-b border-blue-gray-50">
